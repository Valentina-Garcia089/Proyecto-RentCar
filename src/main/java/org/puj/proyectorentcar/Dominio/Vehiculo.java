    ...
    public class Vehiculo {
        ...
        public void setPlaca(char[] placa) throws PlacaException {
            ...
            if (placa.length != 6) {
                throw new PlacaException("La placa debe contener exactamente 3 letras seguidas de 3 números");
            }

            // Validar formato: 3 letras seguidas de 3 números
            for (int i = 0; i < 3; i++) {
            ...
            for (int i = 3; i < 6; i++) {
                if (!Character.isDigit(placa[i])) {
                    throw new PlacaException("Los últimos 3 caracteres deben ser números");
                }
            }
